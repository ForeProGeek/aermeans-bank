  ...
  return (
    <div className="min-h-screen pb-24 md:pb-28">
      ...
      <div className="px-4 md:px-8 md:grid md:grid-cols-2 md:gap-6">
        ...
        <div>
          {/* Wallet Balance Card */}
          <div className="mb-3 md:mb-4 rounded-2xl overflow-hidden relative bg-gradient-to-r from-blue-600 to-blue-800 p-5 md:p-6">
          ...
          <div className="mb-4 md:mb-6 rounded-xl bg-gold-dark/60 p-4 md:p-5">
          ...
          {/* Quick Actions */}
          <div className="mb-4 md:mb-6 rounded-2xl bg-navy-700 p-5 md:p-6">
        ...
        <div>
          ...
          <div className="mb-5 md:mb-6 rounded-2xl bg-navy-700 p-4 md:p-6">
          ...
          <div className="mb-4">
            ...
            <div className="rounded-2xl bg-navy-700 p-5 md:p-6">
